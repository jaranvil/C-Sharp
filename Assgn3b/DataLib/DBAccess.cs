...
namespace DataLib
{
    public class DBAccess
    {
        ...
        private class DataHelper : DataContext
        {
            ...
            public DataHelper() :
                base("Data Source=(localdb)\\Projects; Initial Catalog=Assgn3Data; Integrated Security=True"
                + "AttachDbFilename=H:\\Repos\\C-Sharp\\Assgn3\\Assgn3Data.mdf ; Initial Catalog=Assgn3Data; Integrated Security=True")
            { }
        ...
        {
            data.GetTable<Quiz>().InsertOnSubmit(quiz);
            data.SubmitChanges();
        }

        public void SaveExaminee(Examinee person)
        {
            data.GetTable<Examinee>().InsertOnSubmit(person);
            data.SubmitChanges();
        }
